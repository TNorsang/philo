...
export default function Home() {
  ...
  return (
    <main className="relative">
      ...
      <motion.div className="bg-gradient-to-b from-white to-gray-300 w-[200] h-[80] flex justify-center items-center absolute right-[16] top-[424] text-[24px] font-semibold text-customFontOrange">
