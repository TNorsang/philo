...
export default function Home() {
  ...
  return (
    <main className="relative h-screen overflow-hidden">
      ...
      <motion.div>
        <Image
          className="absolute top-[235px] sm:top-[264px] right-[32px] sm:right-[312px] sm:w-[313px] sm:h-[344px] z-50"
          alt="Bay Max"
          src="/images/bmax.png"
          width={172}
          height={189}
      ...
      <motion.div className="absolute top-[152px] left-[40px] sm:left-[368px] sm:top-[184px] z-50">
