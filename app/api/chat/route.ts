...
export async function POST(req: Request) {
  try {
    ...
    const themeMessage =
      'Every response should be extremely sicnere and helpful. After wards always remember what they say and at times mention what they said later on to keep the conversation flowing and realistic.'
    const ruleMessage =
